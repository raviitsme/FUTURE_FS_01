...
const CARDS = [
  {
    ...
    label: "MINDSET",
    title: "Intentional\nEngineering",
    body: "Code is never just logic — it's a conversation with the person on the other side of the screen. Every animation, every load time, every shadow is a decision.",
    color: "#22D3EE",
    rgb: "34,211,238",
  },
  {
  ...
  },
  {
    ...
    label: "MISSION",
    title: "Shaping\nTomorrow",
    body: "The web I grew up with was static. The web I'm building is alive. I want to be at the frontier of that shift.",
    color: "#EC4899",
    rgb: "236,72,153",
  },
];
